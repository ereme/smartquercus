...
class ProvinciaController extends AbstractController
{
    ...
    {
        return $this->render('provincia/index.html.twig', ['provincias' => $provinciaRepository->findAll()]);
    }
    ...
    {
        return $this->render('provincia/show.html.twig', ['provincium' => $provincium]);
    }
    ...
    public function edit(Request $request, Provincia $provincium): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('provincia_edit', ['id' => $provincium->getId()]);
        }
