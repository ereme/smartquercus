 ...
 */
final class Version20181129083123 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_30B25055763C8AA7 ON opina');
        $this->addSql('ALTER TABLE opina DROP imagen_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE opina ADD imagen_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE opina ADD CONSTRAINT FK_30B25055763C8AA7 FOREIGN KEY (imagen_id) REFERENCES imagen (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_30B25055763C8AA7 ON opina (imagen_id)');
